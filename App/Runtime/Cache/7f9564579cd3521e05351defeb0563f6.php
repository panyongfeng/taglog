...
<body class="no_index">
	...
	<div class="w980 main_table">
		...
		<div class="form_main">
			<form method="post" id="register_form" action="<?php echo U('member/resetpw');?>">
				<div class="form_box">
					<input type="text" name="password" id="password" value="请输入新密码" />
				...
				<input type="hidden" name="verify_code" value="<?php echo ($_GET['verify_code']); ?>"/>
...
<script>
	...
	$('#password').focus(function(){
		...
		$(this).siblings('.tip').show().children('#passwordTip').html('请输入新密码');
	}).blur(function(){
